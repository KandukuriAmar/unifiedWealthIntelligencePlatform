...
import { getUsers, getAssignments, UserItem } from '@/lib/admin-actions';
...
export default function AdminUsers() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      const myUsers = allUsers.filter(u => myAssignedUserIds.includes(u.investor_id));
      setUsers(myUsers);
    } catch (e: any) {
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Browse registered clients and access compliance profiles.
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            ...
            className="pl-10 border-slate-200 dark:border-slate-800 focus-visible:ring-purple-500 bg-white/50 dark:bg-slate-950/50 backdrop-blur-sm"
          />
        </div>
      </div>
      ...
      <Card className="border-slate-200 shadow-sm dark:border-slate-800 bg-white/50 dark:bg-slate-950/50 backdrop-blur-sm">
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Showing {filteredUsers.length} of {users.length} clients registered.
          </CardDescription>
        </CardHeader>
                  ...
                  filteredUsers.map((u) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <Badge variant="secondary" className="font-mono bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400">
                          {u.pan_number || 'N/A'}
                        </Badge>
                      </td>
